                                ...
                                <Box sx={{ display: "flex", justifyContent: "center" }}>
                                    ...
                                    >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style={{ padding: "8px 12px" }}>
                                                    Cumulative CH₄ emission (up to stage {stage + 1})
                                                </td>
                                                <td style={{ padding: "8px 12px", textAlign: "right" }}>
                                            ...
                                            <tr>
                                                <td style={{ padding: "8px 12px" }}>
                                                    Cumulative N₂O emission (up to stage {stage + 1})
                                                </td>
                                                <td style={{ padding: "8px 12px", textAlign: "right" }}>
